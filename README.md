...
![Version](https://img.shields.io/badge/version-1.0.100-red)
...
npm run stage:chrome         # yalnız Chrome üçün ayrılmış stage qovluğu
npm run stage:firefox        # yalnız Firefox üçün ayrılmış stage qovluğu
